...
public class CastDetail extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   ab.setDisplayHomeAsUpEnabled(true);*/
      ...
      /*  if(savedInstanceState==null){
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    case R.id.about_page:
                        Intent intent=new Intent(CastDetail.this, About.class);
                        startActivity(intent);
                    case R.id.moviespage:
                        Intent intent1=new Intent(CastDetail.this,MainActivity.class);
        ...
        tabLayout.addTab(tabLayout.newTab().setText("CREDITS"),1);
        tabLayout.addTab(tabLayout.newTab().setText("BIOGRAPHY"),2);
        ...
        PagerAdapter3 adapter=new PagerAdapter3(getSupportFragmentManager(),tabLayout.getTabCount());
