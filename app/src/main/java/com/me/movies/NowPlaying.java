...
public class NowPlaying extends Fragment implements View.OnClickListener {
  ...
  /*  static ArrayList<ArrayList<String>> relatedMovies=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // sharedPref=new SharedPref();
        ...
        if (getActivity() != null) {
            ...
            CastAdapter adapter = new CastAdapter(getActivity(), array, width,array1,array2,sharedPref.getValue(getActivity(),"nowplaying"));
            gridview=(GridView)rootView.findViewById(R.id.gridview);
            gridview.setColumnWidth(width);
            Log.e("now playing","oncreate adapter");
            ...
            if(sharedPref.getValue(getActivity(),"nowplaying")==true){
    ...
    public void onStart() {
super.onStart();
        //sharedPref.save(getActivity(),false,"nowplaying");
            ...
            public void onResponse(Call<MoviesResponse> call, Response<MoviesResponse> response) {
                if(response.body()!=null){
                    ...
                    if (movies != null) {
                        ...
                        CastAdapter adapter = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"nowplaying"));
                        ...
                        { gridview.setNumColumns(GridView.AUTO_FIT);
                        gridview.setColumnWidth(width);}
                        Log.e("now playing","excute adapter");
                        gridview.setAdapter(adapter);
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.changelist:
                ...
                sharedPref.save(getActivity(),true,"nowplaying");
                CastAdapter adapter = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"nowplaying"));
                gridview.setAdapter(adapter);
            ...
            case R.id.changegrid:
                ...
                gridview.setColumnWidth(width);
                sharedPref.save(getActivity(),false,"nowplaying");
                CastAdapter adapter1 = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"nowplaying"));
