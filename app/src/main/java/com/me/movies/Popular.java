    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // sharedPref=new SharedPref();
        ...
        if (getActivity() != null) {
            ...
            CastAdapter adapter = new CastAdapter(getActivity(), array, width,array1,array2,sharedPref.getValue(getActivity(),"popular"));
            gridview=(GridView)rootView.findViewById(R.id.gridview);
            gridview.setColumnWidth(width);
            Log.e("popular","oncreate adapter");
            ...
            public void onResponse(Call<MoviesResponse> call, Response<MoviesResponse> response) {
                if(response.body()!=null){
                    ...
                    if (movies != null) {
                        ...
                        CastAdapter adapter = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"popular"));
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.changegrid:
                ...
                CastAdapter adapter1 = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"popular"));
