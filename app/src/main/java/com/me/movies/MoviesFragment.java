...
public class MoviesFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // sharedPref.getValue(getActivity());
        list=sharedPref.getValue(getActivity(),"moviesfragment");
        ...
        if (getActivity() != null) {
            ...
            CastAdapter adapter = new CastAdapter(getActivity(), array, width,array1,array2,list);
            gridview=(GridView)rootView.findViewById(R.id.gridview);
            gridview.setColumnWidth(width);
            Log.e("movies fragment","oncreate adapter");
            ...
            if(sharedPref.getValue(getActivity(),"moviesfragment")==true){
            ...
            public void onResponse(Call<MoviesResponse> call, Response<MoviesResponse> response) {
                if(response.body()!=null){
                    ...
                    if (movies != null) {
                        ...
                        CastAdapter adapter = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"moviesfragment"));
                        ...
                        if(sharedPref.getValue(getActivity(),"moviesfragment")==true)
                            ...
                            gridview.setNumColumns(GridView.AUTO_FIT);
                        gridview.setColumnWidth(width);}
                        Log.e("moviesfragment","excute adapter");
                        gridview.setAdapter(adapter);
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.changelist:
                ...
                sharedPref.save(getActivity(),true,"moviesfragment");
                CastAdapter adapter = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"moviesfragment"));
                gridview.setAdapter(adapter);
            ...
            case R.id.changegrid:
                gridview.setNumColumns(GridView.AUTO_FIT);
                gridview.setColumnWidth(width);
                sharedPref.save(getActivity(),false,"moviesfragment");
                CastAdapter adapter1 = new CastAdapter(getActivity(), poster, width,titles,dates,sharedPref.getValue(getActivity(),"moviesfragment"));
